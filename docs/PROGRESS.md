...
| E04 Registry | CLOSED | normalized npm/PyPI/GitHub history, store-backed 24-hour cache, independent GitHub validators, typed offline/wire failures, HIST transitions, and production doctor wiring pass ([G013 evidence](../.omo/ulw-execute/evidence/g013-quality-gate.json)) |
